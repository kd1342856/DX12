...
public:
	...
	auto begin() const { return m_componentArray.begin(); }
	auto end() const { return m_componentArray.end(); }
	size_t GetSize() const { return m_size; }
	Entity GetEntityFromIndex(size_t index) const { return m_indexToEntity.at(index); }
...
public:
	...
	ComponentArray<T>& GetComponentArray()
	{
		...
		assert(it != m_componentArrays.end() && "未登録のコンポネント型");
