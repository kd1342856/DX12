...
bool Modeloader::Load(std::string filepath, std::vector<ModelData::Node>& nodes)
{
...
std::shared_ptr<Mesh> Modeloader::Parse(const aiScene* pScene, const aiMesh* pMesh, const aiMaterial* pMaterial, const std::string& dirPath)
{
