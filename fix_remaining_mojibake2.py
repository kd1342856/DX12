...
ALREADY_FIXED = {
    ...
    r"c:\GitHub\DX12\Source\Application\Script\Character\Ghost\GhostAI.cpp",
...
REVERSE_PROJ_MAP = [
    ...
    (r"Source/Framework/Manager/Scene/Scene.h", r"Source/Framework/Manager/Scene.h"),
    (r"Source/Framework/Manager/Scene/Scene.cpp", r"Source/Framework/Manager/Scene.cpp"),
    (r"Source/Framework/Manager/Scene/SceneManager.h", r"Source/Framework/Manager/SceneManager.h"),
    (r"Source/Framework/Manager/Scene/SceneManager.cpp", r"Source/Framework/Manager/SceneManager.cpp"),
    (r"Source/Framework/Manager/Collision/CollisionManager.h", r"Source/Framework/Manager/CollisionManager.h"),
    (r"Source/Framework/Manager/Collision/CollisionManager.cpp", r"Source/Framework/Manager/CollisionManager.cpp"),
    (r"Source/Framework/Manager/Collision/CollisionShape.h", r"Source/Framework/Manager/CollisionShape.h"),
    (r"Source/Framework/Manager/Collision/CollisionShape.cpp", r"Source/Framework/Manager/CollisionShape.cpp"),
    (r"Source/Framework/Manager/Collision/CollisionSolver.h", r"Source/Framework/Manager/CollisionSolver.h"),
    (r"Source/Framework/Manager/Collision/CollisionSolver.cpp", r"Source/Framework/Manager/CollisionSolver.cpp"),
    (r"Source/Framework/Manager/Resource/ResourceManager.h", r"Source/Framework/Manager/ResourceManager.h"),
    (r"Source/Framework/Manager/Resource/ResourceManager.cpp", r"Source/Framework/Manager/ResourceManager.cpp"),
    (r"Source/Framework/Manager/Resource/PrefabManager.h", r"Source/Framework/Manager/PrefabManager.h"),
    (r"Source/Framework/Manager/Resource/PrefabManager.cpp", r"Source/Framework/Manager/PrefabManager.cpp"),
    (r"Source/Framework/Manager/Audio/AudioManager.h", r"Source/Framework/Manager/AudioManager.h"),
    (r"Source/Framework/Manager/Audio/AudioManager.cpp", r"Source/Framework/Manager/AudioManager.cpp"),
    (r"Source/Framework/Manager/Animation/AnimationManager.h", r"Source/Framework/Manager/AnimationManager.h"),
    (r"Source/Framework/Manager/Animation/AnimationManager.cpp", r"Source/Framework/Manager/AnimationManager.cpp"),
...
print("Restored all remaining files.")
