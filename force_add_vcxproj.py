...
def force_add_to_vcxproj():
    path = r'c:\GitHub\DX12\DX12Framework.vcxproj'
    with open(path, 'r', encoding='utf-8') as f:
        content = f.read()

    target_cpp = '<ClCompile Include="Source\\Framework\\GameManager.cpp" />'
    ...
    target_h = '<ClInclude Include="Source\\Framework\\GameManager.h" />'
